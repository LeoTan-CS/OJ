    ...
    <div className="min-h-screen bg-slate-50">
      <header className="border-b bg-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <div>
            <div className="text-lg font-bold text-slate-950">Bench AI Leaderboard</div>
            <div className="text-xs text-slate-500">{user.nickname} · {user.role}</div>
          </div>
          <nav className="flex items-center gap-1">
            {user.role === "USER" && <NavLink href="/competitions">比赛</NavLink>}
...
export function AdminNav() {
  return (
    <div className="mb-6 flex flex-wrap gap-2">
      ...
      <NavLink href="/admin/competitions">比赛</NavLink>
